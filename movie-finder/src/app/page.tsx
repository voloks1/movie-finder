	...
	return (
		<>
			<div className="h-screen w-screen overflow-x-hidden">
				<div className="w-full h-20 flex items-center border-b border-b-zinc-800 bg-zinc-950">
					<div className="flex flex-row mx-8 w-11/12">
						<div className="">
						...
						<div className="ml-auto flex items-center">
							<span>
								<Dialog>
									<DialogTrigger className="flex flex-row bg-accentColor w-28 justify-between h-8 rounded-lg gap-x-2 items-center font-semibold text-white pl-2">
										Buscar
				...
				<div className="grid grid-cols-page h-screen w-screen">
					<div className="border-r border-r-zinc-800 p-4 flex flex-col text-white gap-y-2 bg-zinc-950">
						<p>Filmes</p>
						<p>Séries e animes</p>
						<p>Mais assistidos</p>
