...
export const MovieCard = ({ movie }: MovieCardProps) => {
	...
	return (
		<>
			<Card
				className="overflow-hidden cursor-pointer hover:scale-105 transition-transform border-zinc-800 rounded-lg"
								...
								<div className="md:col-span-2 space-y-4">
									...
									<div className="flex flex-wrap gap-2">
										{movieDetails.genres.map((genre) => (
											<span
												key={genre.id}
												className="px-3 py-1 bg-amber-500 font-semibold text-black rounded-full text-sm">
												{genre.name}
											</span>
										))}
									</div>
